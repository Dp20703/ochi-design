...
const Footer = () => {
    return (
        <div className='flex gap-5 h-screen w-full  bg-zinc-900 p-20'>
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="heading">
                    <h1 className='text-[7vw] uppercase font-bold leading-none -mb-7'>EYE-</h1>
                    <h1 className='text-[7vw] uppercase font-bold leading-none -mb-7'>OPENING</h1>
                </div>
            ...
            <div className="w-1/2 ">
                <h1 className='text-[6vw] uppercase font-bold leading-none -mb-7'>PRESENTATIONS</h1>
